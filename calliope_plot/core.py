...
Functionality to plot Calliope model data.
...
from calliope_plot.capacity import plot_capacity
from calliope_plot.timeseries import plot_timeseries
from calliope_plot.transmission import plot_transmission
from calliope_plot.flows import plot_flows
from calliope_plot.util import type_of_script
...
def plot_summary(model, to_file=False, mapbox_access_token=None):
    ...
    template_path = os.path.join(os.path.dirname(__file__), "plots_template.html")
