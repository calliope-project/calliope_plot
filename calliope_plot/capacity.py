...
from calliope_plot.util import get_data_layout, break_name
...
def plot_capacity(
    ...
    data, layout = get_data_layout(
        ...
        get_var_layout_kwargs={
            'location_axis': location_axis, 'value_axis': value_axis},
    )
